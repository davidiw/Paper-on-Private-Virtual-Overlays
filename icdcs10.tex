...
overlays creating a fragmented overlay.  The underlying issue was that the
fragmented overlays believed they were in a well-formed state and thus never
reviewed the DHT list to determine if there were peers that should be their
neighbors.  This caused the overlays to remain fragmented until either a new
...
but at that point, the nodes have already fragmented.
